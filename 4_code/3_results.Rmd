...
# ICC and ICC2 results - lobes
out_CT_lobe <- read.csv("2_analysis_output/out_CT_lobe.csv")
out_SA_lobe <- read.csv("2_analysis_output/out_SA_lobe.csv")
out_GM_lobe <- read.csv("2_analysis_output/out_GM_lobe.csv")
...
out_CT_Destrieux <- read.csv("2_analysis_output/out_CT_Destrieux.csv")
#sites_LRTs_CT_tidy_aicbic_Destrieux <- read.csv("2_analysis_output/sites_LRTs_CT_tidy_aicbic_Destrieux.csv")
#multigroup_CFIs_CT_Destrieux <- read.csv("2_analysis_output/multigroup_CFIs_CT_Destrieux.csv")
#Destrieux_voxel <- read.csv("1_raw_data/destrieux.csv")
...
mean(out_CT$ICC - out_CT$ICC_lower95CI)
mean(out_CT$ICC_higher95CI - out_CT$ICC)

range(out_CT$ICC - out_CT$ICC_lower95CI)
range(out_CT$ICC_higher95CI - out_CT$ICC)

mean(out_CT$ICC_higher95CI - out_CT$ICC_lower95CI)
range(out_CT$ICC_higher95CI - out_CT$ICC_lower95CI) # range to include

mean(out_SA$ICC, na.rm = TRUE)
median(out_SA$ICC, na.rm = TRUE)
range(out_SA$ICC, na.rm = TRUE)

mean(out_SA$ICC - out_SA$ICC_lower95CI)
mean(out_SA$ICC_higher95CI - out_SA$ICC)

mean(out_SA$ICC_higher95CI - out_SA$ICC_lower95CI)
range(out_SA$ICC_higher95CI - out_SA$ICC_lower95CI)

mean(out_GM$ICC, na.rm = TRUE)
median(out_GM$ICC, na.rm = TRUE)
range(out_GM$ICC, na.rm = TRUE)

mean(out_GM$ICC - out_GM$ICC_lower95CI)
mean(out_GM$ICC_higher95CI - out_GM$ICC)

mean(out_GM$ICC_higher95CI - out_GM$ICC_lower95CI)
range(out_GM$ICC_higher95CI - out_GM$ICC_lower95CI)
...
```{r grey_summary_lobes}

# simple summary statistics

# ICC

mean(out_CT_lobe$ICC, na.rm = TRUE)
median(out_CT_lobe$ICC, na.rm = TRUE)
range(out_CT_lobe$ICC, na.rm = TRUE)

sum(out_CT_lobe$ICC < .7) / nrow(out_CT_lobe)
sum(out_CT_lobe$ICC < .75) / nrow(out_CT_lobe)


mean(out_SA_lobe$ICC, na.rm = TRUE)
median(out_SA_lobe$ICC, na.rm = TRUE)
range(out_SA_lobe$ICC, na.rm = TRUE)

mean(out_GM_lobe$ICC, na.rm = TRUE)
median(out_GM_lobe$ICC, na.rm = TRUE)
range(out_GM_lobe$ICC, na.rm = TRUE)

# ICC2

mean(out_CT_lobe$ICC2, na.rm = TRUE)
median(out_CT_lobe$ICC2, na.rm = TRUE)
range(out_CT_lobe$ICC2, na.rm = TRUE)

sum(out_CT_lobe$ICC2 < .7) / nrow(out_CT_lobe)

mean(out_SA_lobe$ICC2, na.rm = TRUE)
median(out_SA_lobe$ICC2, na.rm = TRUE)
range(out_SA_lobe$ICC2, na.rm = TRUE)

mean(out_GM_lobe$ICC2, na.rm = TRUE)
median(out_GM_lobe$ICC2, na.rm = TRUE)
range(out_GM_lobe$ICC2, na.rm = TRUE)
...
## CT
# compare lobe ICC and mean ICC for DK regions in that lobe
comp_DK_lobe_CT <- left_join(out_CT, lobes2, by = "label") %>%
  left_join(out_CT_lobe, by = c("lobe" = "label")) %>%
  group_by(lobe) %>%
  summarise(mean_DK = mean(ICC.x),
            mean_lobe = mean(ICC.y),
            mean_diff = mean_lobe - mean_DK)

# mean difference is 0.00, range -.05 to .04.
mean(comp_DK_lobe_CT$mean_diff)
range(comp_DK_lobe_CT$mean_diff)

## SA
# compare lobe ICC and mean ICC for DK regions in that lobe
comp_DK_lobe_SA <- left_join(out_SA, lobes2, by = "label") %>%
  left_join(out_SA_lobe, by = c("lobe" = "label")) %>%
  group_by(lobe) %>%
  summarise(mean_DK = mean(ICC.x),
            mean_lobe = mean(ICC.y),
            mean_diff = mean_lobe - mean_DK)

# mean difference is 0.02, range .00 to .04.
mean(comp_DK_lobe_SA$mean_diff)
range(comp_DK_lobe_SA$mean_diff)

# compare lobe ICC and mean ICC for DK regions in that lobe
comp_DK_lobe_GM <- left_join(out_GM, lobes2, by = "label") %>%
  left_join(out_GM_lobe, by = c("lobe" = "label")) %>%
  group_by(lobe) %>%
  summarise(mean_DK = mean(ICC.x),
            mean_lobe = mean(ICC.y),
            mean_diff = mean_lobe - mean_DK)

# mean difference is 0.02, range 0.0 to .05.
mean(comp_DK_lobe_GM$mean_diff)
range(comp_DK_lobe_GM$mean_diff)

```

```{r Cortical_Thickness_ICCfigs_lobes}
...
```{r Grey_Matter_Volume_ICCfigs_lobes}
...
```{r grey_figures_ICC_lobes}

# plot and save all ICC figures
Cairo(file = "6_figures/Figure9_original.png",
      type = "png",
      units="in", 
      width=6, 
      height=5, 
...
Figure9_lobe <- CT_ICC1_lobe / SA_ICC1_lobe / GM_ICC1_lobe + plot_layout(guides = 'collect') & theme(legend.position = "bottom",
                  legend.key.width=unit(1,"cm"), legend.key.height = unit(.5,"cm"))
...
```{r grey_figures_ICC2_lobes, eval = FALSE}

# plot and save all ICC2 figures
Cairo(file = "6_figures/Figure3_lobe.png",
      type = "png",
      units="in", 
      width=6, 
      height=5, 
...
Figure_3_lobe <- CT_ICC2_lobe / SA_ICC2_lobe / GM_ICC2_lobe + plot_layout(guides = 'collect') & theme(legend.position = "bottom",
                  legend.key.width=unit(1,"cm"), legend.key.height = unit(.5,"cm"))
...
out_CT_Destrieux %>%
 ...
 Destrieux_atlas <- ggsegDesterieux::desterieux %>%
   as_tibble() %>%
   left_join(out_CT_Destrieux, by = "label") %>% 
   as_brain_atlas()
 
#View(Destrieux_atlas$data)

Cairo(file = "6_figures/Figure10.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
Destrieux_ICC_fig1 <- ggplot() +
   geom_brain(atlas = Destrieux_atlas,
              mapping = aes(fill = ICC),
              #position = position_brain(hemi ~ side)
              ) +
   theme_brain() +
   scale_fill_continuous(limits = c(0, .7), type = "viridis",
                         name = "longitudinal stability") +
   ggtitle("Cortical Thickness ICC") +
   theme(legend.position = "none",
         #legend.key.width=unit(1,"cm"), 
         #legend.key.height = unit(.5,"cm"),
         axis.text = element_blank()) 

Destrieux_ICC_fig2 <- ggplot() +
   geom_brain(atlas = Destrieux_atlas,
              mapping = aes(fill = ICC2),
              #position = position_brain(hemi ~ side)
              ) +
   ...
   scale_fill_continuous(limits = c(0, .7), type = "viridis",
                         name = "longitudinal stability") +
   ggtitle("Cortical Thickness ICC2") +
   theme(legend.position = "bottom",
         legend.key.width=unit(1,"cm"), 
         legend.key.height = unit(.5,"cm"),
         axis.text = element_blank())

Destrieux_CFI_fig3 <- ggplot() +
   geom_brain(atlas = Destrieux_atlas,
              mapping = aes(fill = equal_CFI),
              #position = position_brain(hemi ~ side)
              ) +
   theme_brain() +
...
# Destrieux_ICC_figs <- Destrieux_ICC_fig1 / Destrieux_ICC_fig2 + plot_layout(guides = 'collect') & theme(legend.position = "bottom",
#                   legend.key.width=unit(1,"cm"), legend.key.height = unit(.5,"cm"))

Destrieux_ICC_fig1 / Destrieux_ICC_fig2 / Destrieux_CFI_fig3 
#& theme(legend.position = "bottom",
#                  legend.key.width=unit(1,"cm"), legend.key.height = unit(.5,"cm"))
...
```{r atlas_comparison_figure11}



CT_ICC1_comparisons <- ggseg(comb_CT, atlas = dk, 
      colour = "black",
      size = .1, 
      #position = "stacked",
      mapping = aes(fill = ICC)) +
...
Destrieux_ICC_fig1_comparisons <- ggplot() +
   geom_brain(atlas = Destrieux_atlas,
              mapping = aes(fill = ICC),
              #position = position_brain(hemi ~ side)
              ) +
...
Cairo(file = "6_figures/Figure11_original.png",
      type = "png",
      units="in", 
      width=6, 
      height=5, 
...
Figure11_comparisons <- (CT_ICC1_comparisons / CT_ICC1_lobe_comparisons / Destrieux_ICC_fig1_comparisons) + plot_layout(guides = "collect") & theme(legend.position = "bottom", legend.key.width=unit(1,"cm"), legend.key.height = unit(.5,"cm")) & scale_fill_continuous(limits = c(0, 1), type = "viridis",
                         name = "ICC")

Figure11_comparisons

dev.off()

```

### correlate voxel count and ICC

```{r voxels}

Destrieux_voxel2 <- Destrieux_voxel %>%
  rename("label" = region,
         "lh" = left,
         "rh" = right) %>%
...
Destrieux_voxel2_ICC <- fuzzyjoin::stringdist_join(out_CT_Destrieux, 
                           Destrieux_voxel2,
                           by = "label",
...
cor.test(Destrieux_voxel2_ICC$ICC, Destrieux_voxel2_ICC$voxel, method = "spearman")

ggplot(data = Destrieux_voxel2_ICC,
       aes(x = voxel, y = ICC)) +
...
```{r betweenanderrormain_CT_regions, eval = FALSE}

by_ROI_CT_box_error_Destrieux <- between_error_CT_Destrieux %>%
  filter(grepl("rh_", ROI)) %>%
  mutate(ROI = str_replace(ROI, "rh_", "")) %>%
  ggplot(aes(x = reorder(ROI, -time_var, FUN = median),
             y = error_var)) +
...
by_ROI_CT_box_time_Destrieux <- between_error_CT_Destrieux %>%
    filter(grepl("rh_", ROI)) %>%
    mutate(ROI = str_replace(ROI, "rh_", "")) %>%
  ggplot(aes(x = reorder(ROI, -time_var, FUN = median),
             y = time_var)) +
...
by_ROI_ICC_CT_Destrieux <- between_error_CT_Destrieux %>%
  filter(grepl("rh_", ROI)) %>%
  mutate(ROI = str_replace(ROI, "rh_", "")) %>%
  group_by(ROI) %>%
  summarise(m_ICC = median(ICC),
...
Cairo(file = "6_figures/Figure4_Destrieux.png",
      type = "png",
      units="in", 
      width=8, 
      height=8, 
...
Figure_4_Destrieux <- by_ROI_CT_box_time_Destrieux + by_ROI_CT_box_error_Destrieux + by_ROI_ICC_CT_Destrieux + plot_layout(widths = c(4,4,1))

print(Figure_4_Destrieux)
...
```{r betweenanderrormain_CT_sites, eval = FALSE}
...
by_site_CT_box_error_Destrieux <- between_error_CT_Destrieux %>%
  ggplot(aes(x = reorder(site, -error_var, FUN = median),
             y = error_var)) +
  geom_point(aes(colour = site),
             position = position_jitter(width = .25),
...
by_site_CT_box_true_Destrieux <- between_error_CT_Destrieux %>%
  ggplot(aes(x = reorder(site, -error_var, FUN = median),
             y = time_var)) +
  geom_point(aes(colour = site),
             position = position_jitter(width = .25),
...
by_site_ICC_CT_Destrieux <- between_error_CT_Destrieux %>%
  filter(grepl("rh_", ROI)) %>%
  mutate(ROI = str_replace(ROI, "rh_", "")) %>%
  group_by(site) %>%
  summarise(m_ICC = median(ICC),
...
Cairo(file = "6_figures/Figure5_Destrieux.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
Figure_5_Destrieux <- by_site_CT_box_true_Destrieux + by_site_CT_box_error_Destrieux + by_site_ICC_CT_Destrieux + plot_layout(widths = c(4,4,1))

print(Figure_5_Destrieux)
...
multigroup_CFIs_CT_Destrieux <- multigroup_CFIs_CT_Destrieux %>%
  mutate(errcon_v_con = m_e_constrained - m_constrained,
         uncon_v_errcon = m_unconstrained - m_e_constrained,
         timecon_v_con = m_time_constrained - m_constrained,
         uncon_v_timecon = m_unconstrained - m_time_constrained,
...
min_deltaCFI_CT_Destrieux <- multigroup_CFIs_CT_Destrieux %>%
  select(errcon_v_con, uncon_v_errcon, timecon_v_con, uncon_v_timecon, uncon_v_con) %>%
  min(na.rm = TRUE)

max_deltaCFI_CT_Destrieux <- multigroup_CFIs_CT_Destrieux %>%
  select(errcon_v_con, uncon_v_errcon, timecon_v_con, uncon_v_timecon, uncon_v_con) %>%
  max(na.rm = TRUE)

# for added info

multigroup_CFIs_CT_Destrieux %>%
  pivot_longer(cols = c(errcon_v_con,
uncon_v_errcon,
timecon_v_con,
uncon_v_timecon,
...
deltaCFI_errcon_v_con_CT_Destrieux <- Destrieux %>% 
  as_tibble() %>% 
  left_join(multigroup_CFIs_CT_Destrieux, by = c("label" = "region")) %>%
  ggplot() +
  geom_brain(atlas = Destrieux_atlas,
             colour = "black",
        size = .1,
    ...
    theme_void() +
  scale_fill_continuous(name = "delta CFI",
                        limits = c(min_deltaCFI_CT_Destrieux,
                                   max_deltaCFI_CT_Destrieux),
                        type = "viridis") +
  ggtitle("A. Constrained vs Between-subjects varying")

deltaCFI_uncon_v_errcon_CT_Destrieux <- Destrieux %>% 
  as_tibble() %>% 
  left_join(multigroup_CFIs_CT_Destrieux, by = c("label" = "region")) %>%
ggplot() +
  geom_brain(atlas = Destrieux_atlas,
...
deltaCFI_timecon_v_con_CT_Destrieux <- Destrieux %>% 
  as_tibble() %>% 
  left_join(multigroup_CFIs_CT_Destrieux, by = c("label" = "region")) %>%
ggplot() +
  geom_brain(atlas = Destrieux_atlas,
...
deltaCFI_uncon_v_timecon_CT_Destrieux <- Destrieux %>% 
  as_tibble() %>% 
  left_join(multigroup_CFIs_CT_Destrieux, by = c("label" = "region")) %>%
ggplot() +
  geom_brain(atlas = Destrieux_atlas,
...
deltaCFI_uncon_v_con_CT_Destrieux <- Destrieux %>% 
  as_tibble() %>% 
  left_join(multigroup_CFIs_CT_Destrieux, by = c("label" = "region")) %>%
ggplot() +
  geom_brain(atlas = Destrieux_atlas,
...
Cairo(file = "6_figures/Figure7_Destrieux.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
Figure7_Destrieux <- deltaCFI_errcon_v_con_CT_Destrieux / deltaCFI_uncon_v_errcon_CT_Destrieux / deltaCFI_timecon_v_con_CT_Destrieux / deltaCFI_uncon_v_timecon_CT_Destrieux / deltaCFI_uncon_v_con_CT_Destrieux + plot_layout(guides = "collect") & theme(legend.position = "bottom", legend.key.width = unit(1, "cm"), legend.title.align=0.5)

print(Figure7_Destrieux)
...
Figure7_CT_scanners <- deltaCFI_errcon_v_con_CT_scanners / deltaCFI_uncon_v_errcon_CT_scanners / deltaCFI_timecon_v_con_CT_scanners / deltaCFI_uncon_v_timecon_CT_scanners / deltaCFI_uncon_v_con_CT_scanners + plot_layout(guides = "collect") & theme(legend.position = "bottom", legend.key.width = unit(1, "cm"), legend.title.align=0.5)

print(Figure7_CT_scanners)
...
Figure4_CT_scanner <- by_ROI_CT_box_time_scanner + by_ROI_CT_box_error_scanner + by_ROI_ICC_CT_scanner + plot_layout(widths = c(4,4,1))

print(Figure4_CT_scanner)
...
Figure7_SA_scanners <- deltaCFI_errcon_v_con_SA_scanners / deltaCFI_uncon_v_errcon_SA_scanners / deltaCFI_timecon_v_con_SA_scanners / deltaCFI_uncon_v_timecon_SA_scanners / deltaCFI_uncon_v_con_SA_scanners + plot_layout(guides = "collect") & theme(legend.position = "bottom", legend.key.width = unit(1, "cm"), legend.title.align=0.5)

print(Figure7_SA_scanners)
...
Figure7_SA_scanners_sim <- deltaCFI_errcon_v_con_SA_scanners / deltaCFI_uncon_v_errcon_SA_scanners / deltaCFI_timecon_v_con_SA_scanners / deltaCFI_uncon_v_timecon_SA_scanners / deltaCFI_uncon_v_con_SA_scanners + plot_layout(guides = "collect") & theme(legend.position = "bottom", legend.key.width = unit(1, "cm"), legend.title.align=0.5)

 
 print(Figure7_SA_scanners_sim)
...
Figure7_GM_scanners <- deltaCFI_errcon_v_con_GM_scanners / deltaCFI_uncon_v_errcon_GM_scanners / deltaCFI_timecon_v_con_GM_scanners / deltaCFI_uncon_v_timecon_GM_scanners / deltaCFI_uncon_v_con_GM_scanners + plot_layout(guides = "collect") & theme(legend.position = "bottom", legend.key.width = unit(1, "cm"), legend.title.align=0.5)

print(Figure7_GM_scanners)
