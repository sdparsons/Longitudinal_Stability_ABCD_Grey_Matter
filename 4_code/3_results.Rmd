...
# ICC and ICC2 results
out_CT <- read.csv("2_analysis_output/out_CT_sim.csv")
out_SA <- read.csv("2_analysis_output/out_SA_sim.csv")
out_GM <- read.csv("2_analysis_output/out_GM_sim.csv")

#between and within variance estimates (per site) results
between_error_CT <- read.csv("2_analysis_output/between_error_CT_sim.csv")
between_error_SA <- read.csv("2_analysis_output/between_error_SA_sim.csv")
between_error_GM <- read.csv("2_analysis_output/between_error_GM_sim.csv")

# LRT results from multisite
sites_LRTs_CT_tidy <- read.csv("2_analysis_output/sites_LRTs_CT_tidy_aicbic_sim.csv")
sites_LRTs_SA_tidy <- read.csv("2_analysis_output/sites_LRTs_SA_tidy_aicbic_sim.csv")
sites_LRTs_GM_tidy <- read.csv("2_analysis_output/sites_LRTs_GM_tidy_aicbic_sim.csv")

# improved LRT results and CFIS
sites_LRTs_CT_tidy_aicbic <- read.csv("2_analysis_output/sites_LRTs_CT_tidy_aicbic_sim.csv")
multigroup_CFIs_CT <- read.csv("2_analysis_output/multigroup_CFIs_CT_sim.csv")
sites_LRTs_SA_tidy_aicbic <- read.csv("2_analysis_output/sites_LRTs_SA_tidy_aicbic_sim.csv")
multigroup_CFIs_SA <- read.csv("2_analysis_output/multigroup_CFIs_SA_sim.csv")
sites_LRTs_GM_tidy_aicbic <- read.csv("2_analysis_output/sites_LRTs_GM_tidy_aicbic_sim.csv")
multigroup_CFIs_GM <- read.csv("2_analysis_output/multigroup_CFIs_GM_sim.csv")
...
if(use_sim == TRUE) {
Cairo(file = "8_supplement/Figure2_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=5, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure3_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=5, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure4_sim.png",
      type = "png",
      units="in", 
      width=8, 
      height=8, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure5_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure4_SA_sim.png",
      type = "png",
      units="in", 
      width=8, 
      height=8, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure5_SA_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure4_GM_sim.png",
      type = "png",
      units="in", 
      width=8, 
      height=8, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure5_GM_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE) {
Cairo(file = "8_supplement/Figure7_CT_ChisquaredLRT_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure7_SA_ChisquaredLRT_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure7_GM_ChisquaredLRT_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure7_CT_deltaAIC_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure7_SA_deltaAIC_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure7_GM_deltaAIC_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure7_CT_deltaBIC_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure7_SA_deltaBIC_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure7_GM_deltaBIC_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure7_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure7_SA_deltaCFI_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
...
if(use_sim == TRUE){
Cairo(file = "8_supplement/Figure7_GM_deltaCFI_sim.png",
      type = "png",
      units="in", 
      width=6, 
      height=6, 
